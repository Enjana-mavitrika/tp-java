...
public class Test
{
	...
	System.out.println("Le signe de (p1,p2,p3):"+(p1.singeAngle(p2, p3)));
	
	System.out.println("Pol est t-il convexe?? "+pol.estConvexe());
	
	System.out.println("Pol > Pol1 ?? "+pol.plusGrand(pol1)+"\n");
